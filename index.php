...
<head>
  <meta charset="utf-8">
  <title>Freeze socialmedia</title>
...
<body>
  ...
  <div class="register">
    ...
    <form action="register.php" method="post">
      ...
      <br>
    <select aria-label="day" name="day" class="day" title="Dag"><option value="0" selected="1">Dag</option>
    ...
    <select aria-label="month" name="month" class="month" title="Maand">
    ...
    <select aria-label="year" name="year" class="year" title="Jaar">
      ...
      <br>
      <button class="btnreg" type="submit" name="button">Register</button>
    </form>
  </div>
